...
// Type: WhatsApp.WAPDefaultTokenDictionary
...
namespace WhatsApp
{
  public class WAPDefaultTokenDictionary : ITokenDictionary
  {
    private static string[] primaryStrings = new string[236]
    {
      null,
      "xmlstreamstart",
      "xmlstreamend",
    ...
    private static string[][] secondaryStrings = new string[4][]
    {
      new string[256]
      {
        "lg",
    ...
    private static int secondaryStringsStart = WAPDefaultTokenDictionary.primaryStrings.Length;
    private const int dictionaryVersion = 0;

    public string[] PrimaryStrings => WAPDefaultTokenDictionary.primaryStrings;

    public string[][] SecondaryStrings => WAPDefaultTokenDictionary.secondaryStrings;

    public int SecondaryStringsStart => WAPDefaultTokenDictionary.secondaryStringsStart;

    public int DictionaryVersion => 0;
  }
}
