...
// Type: Microsoft.Graph.UserCreatedObjectsCollectionReferencesRequest
...
{
  public class UserCreatedObjectsCollectionReferencesRequest : 
    BaseRequest,
    IUserCreatedObjectsCollectionReferencesRequest,
    IBaseRequest
  {
