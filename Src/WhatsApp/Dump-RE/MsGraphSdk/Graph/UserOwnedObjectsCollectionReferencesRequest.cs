...
// Type: Microsoft.Graph.UserOwnedObjectsCollectionReferencesRequest
...
{
  public class UserOwnedObjectsCollectionReferencesRequest : 
    BaseRequest,
    IUserOwnedObjectsCollectionReferencesRequest,
    IBaseRequest
  {
