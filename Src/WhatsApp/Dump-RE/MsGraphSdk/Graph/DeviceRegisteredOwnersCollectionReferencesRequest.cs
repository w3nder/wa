...
// Type: Microsoft.Graph.DeviceRegisteredOwnersCollectionReferencesRequest
...
{
  public class DeviceRegisteredOwnersCollectionReferencesRequest : 
    BaseRequest,
    IDeviceRegisteredOwnersCollectionReferencesRequest,
    IBaseRequest
  {
