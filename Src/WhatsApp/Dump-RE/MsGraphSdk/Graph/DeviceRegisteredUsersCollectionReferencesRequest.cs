...
// Type: Microsoft.Graph.DeviceRegisteredUsersCollectionReferencesRequest
...
{
  public class DeviceRegisteredUsersCollectionReferencesRequest : 
    BaseRequest,
    IDeviceRegisteredUsersCollectionReferencesRequest,
    IBaseRequest
  {
