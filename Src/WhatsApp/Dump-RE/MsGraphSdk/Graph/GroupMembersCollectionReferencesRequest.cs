...
// Type: Microsoft.Graph.GroupMembersCollectionReferencesRequest
...
{
  public class GroupMembersCollectionReferencesRequest : 
    BaseRequest,
    IGroupMembersCollectionReferencesRequest,
    IBaseRequest
  {
