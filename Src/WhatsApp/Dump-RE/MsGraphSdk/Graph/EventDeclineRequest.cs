...
// Type: Microsoft.Graph.EventDeclineRequest
...
{
  public class EventDeclineRequest : BaseRequest, IEventDeclineRequest, IBaseRequest
  {
    public EventDeclineRequest(string requestUrl, IBaseClient client, IEnumerable<Option> options)
    ...
    public IEventDeclineRequest Expand(string value)
    {
      ...
      return (IEventDeclineRequest) this;
    }
