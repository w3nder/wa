...
// Type: Microsoft.Graph.UserOwnedDevicesCollectionReferencesRequest
...
{
  public class UserOwnedDevicesCollectionReferencesRequest : 
    BaseRequest,
    IUserOwnedDevicesCollectionReferencesRequest,
    IBaseRequest
  {
