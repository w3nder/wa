...
// Type: Microsoft.Graph.UserMemberOfCollectionReferencesRequest
...
{
  public class UserMemberOfCollectionReferencesRequest : 
    BaseRequest,
    IUserMemberOfCollectionReferencesRequest,
    IBaseRequest
  {
