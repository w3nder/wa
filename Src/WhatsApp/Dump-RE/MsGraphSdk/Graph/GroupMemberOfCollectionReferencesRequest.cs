...
// Type: Microsoft.Graph.GroupMemberOfCollectionReferencesRequest
...
{
  public class GroupMemberOfCollectionReferencesRequest : 
    BaseRequest,
    IGroupMemberOfCollectionReferencesRequest,
    IBaseRequest
  {
