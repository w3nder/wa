...
// Type: Microsoft.Graph.UserRegisteredDevicesCollectionReferencesRequest
...
{
  public class UserRegisteredDevicesCollectionReferencesRequest : 
    BaseRequest,
    IUserRegisteredDevicesCollectionReferencesRequest,
    IBaseRequest
  {
