...
// Type: Microsoft.Graph.MessageForwardRequest
...
{
  public class MessageForwardRequest : BaseRequest, IMessageForwardRequest, IBaseRequest
  {
    ...
    public IMessageForwardRequest Expand(string value)
    {
      ...
      return (IMessageForwardRequest) this;
    }
