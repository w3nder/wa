...
// Type: Microsoft.Graph.DirectoryRoleMembersCollectionReferencesRequest
...
{
  public class DirectoryRoleMembersCollectionReferencesRequest : 
    BaseRequest,
    IDirectoryRoleMembersCollectionReferencesRequest,
    IBaseRequest
  {
