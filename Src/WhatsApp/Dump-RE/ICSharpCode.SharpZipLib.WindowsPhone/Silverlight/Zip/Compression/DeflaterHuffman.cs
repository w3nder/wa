...
// Type: ICSharpCode.SharpZipLib.Silverlight.Zip.Compression.DeflaterHuffman
...
namespace ICSharpCode.SharpZipLib.Silverlight.Zip.Compression
{
  public class DeflaterHuffman
  {
    ...
    private readonly DeflaterHuffman.Tree literalTree;
    private readonly DeflaterHuffman.Tree distTree;
    private readonly DeflaterHuffman.Tree blTree;
