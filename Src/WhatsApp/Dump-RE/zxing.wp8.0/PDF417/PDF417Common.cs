...
// Type: ZXing.PDF417.PDF417Common
...
namespace ZXing.PDF417
{
  ...
  internal static class PDF417Common
  {
    ...
    /// <summary>Maximum Codewords (Data + Error).</summary>
    public static readonly int MAX_CODEWORDS_IN_BARCODE = PDF417Common.NUMBER_OF_CODEWORDS - 1;
    ...
    /// <summary>Gets the bit count sum.</summary>
    ...
    {
      int bitCountSum = 0;
      foreach (int num in moduleBitCount)
        bitCountSum += num;
      return bitCountSum;
    }
    ...
    /// <summary>Translate the symbol into a codeword</summary>
    ...
    {
      int codewordIndex = PDF417Common.findCodewordIndex(symbol & 262143L);
      return codewordIndex == -1 ? PDF417Common.INVALID_CODEWORD : (PDF417Common.CODEWORD_TABLE[codewordIndex] - 1) % PDF417Common.NUMBER_OF_CODEWORDS;
    }
    ...
    {
      int num1 = 0;
      int num2 = PDF417Common.SYMBOL_TABLE.Length;
      while (num1 < num2)
      {
        int codewordIndex = num1 + num2 >>> 1;
        if (symbol < (long) PDF417Common.SYMBOL_TABLE[codewordIndex])
        {
          num2 = codewordIndex;
        }
        else
