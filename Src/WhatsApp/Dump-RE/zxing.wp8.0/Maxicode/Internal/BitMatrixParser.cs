...
// Type: ZXing.Maxicode.Internal.BitMatrixParser
...
namespace ZXing.Maxicode.Internal
{
  ...
  internal sealed class BitMatrixParser
  {
    ...
    {
      byte[] numArray1 = new byte[144];
      int height = this.bitMatrix.Height;
      int width = this.bitMatrix.Width;
      for (int y = 0; y < height; ++y)
      {
        int[] numArray2 = BitMatrixParser.BITNR[y];
        for (int x = 0; x < width; ++x)
        {
          int num = numArray2[x];
          if (num >= 0 && this.bitMatrix[x, y])
            numArray1[num / 6] |= (byte) (1 << 5 - num % 6);
        }
      }
      return numArray1;
    }
