...
// Type: Microsoft.OneDrive.Sdk.ItemVersionsCollectionPage
...
{
  public class ItemVersionsCollectionPage : 
    CollectionPage<Microsoft.OneDrive.Sdk.Item>,
    IItemVersionsCollectionPage,
    ...
    IEnumerable
  {
    ...
    public void InitializeNextPageRequest(IBaseClient client, string nextPageLinkString)
    {
      if (string.IsNullOrEmpty(nextPageLinkString))
        return;
      this.NextPageRequest = (IItemVersionsCollectionRequest) new ItemVersionsCollectionRequest(nextPageLinkString, client, (IEnumerable<Option>) null);
    }
  }
}
