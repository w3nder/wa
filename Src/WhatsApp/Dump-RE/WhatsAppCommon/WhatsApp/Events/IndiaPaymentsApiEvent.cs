...
// Type: WhatsApp.Events.IndiaPaymentsApiEvent
...
{
  public class IndiaPaymentsApiEvent : WamEvent
  {
    ...
    public wam_enum_india_payments_request_name_type? requestName;
    ...
    public void Reset()
    {
      ...
      this.requestName = new wam_enum_india_payments_request_name_type?();
    }

    public override uint GetCode() => 1552;
    ...
    public override void SerializeFields()
    {
      ...
      Wam.MaybeSerializeField(9, Wam.EnumToLong<wam_enum_india_payments_request_name_type>(this.requestName));
    }
  }
}
